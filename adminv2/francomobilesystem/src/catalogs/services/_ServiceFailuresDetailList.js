...
const ServiceCommonFailuresList =({failuresList,setFailuresList }) =>{    
    ...
    return ( 
            ...
            {openModalFailure && <MyModal id="id_myModal" title={idFailure > 0 ? "Editar Falla" : "Agregar Falla"} openModal={openModalFailure} closeModal={handleClose} >
                <EditFailureService    idFailure={idFailure} closeModal={handleClose} action={setFailure} />
            </MyModal>}
        </MainCard> 
    )
}
