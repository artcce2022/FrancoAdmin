export const TRANSLATIONS_ES = {
    ...
    'label.ErrorSelectValid' : 'Error, Selecciona Valido',
    'label.SelectSomeValue': ' Seleccione algún valor',
    'label.Serial': 'Serial',
    'label.Cancel' : 'Cancelar',
    'label.Failure': 'Falla',
    'label.SymtomDescription':'Descripción del Problema',
    'label.WorkRequested': 'Trabajo Requerido',
    ...
    'label.PartsCategories' : 'Categorias de Partes',
    'label.PartCategory' : 'Categoria de Parte',
    ...
    'label.PartNumber':'Numero de Parte',
    'label.PartCode': 'Código de Parte',
    'label.Size': 'Tamaño',
